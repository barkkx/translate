...
tittle = 'Music’s Impact and Influence on Everyday Life'
...
user_answer = input('Выберите 1 язык из доступных: ').lower().strip()
translator = Translator() 
translate = translator.translate(all_text, dest=user_answer).text
print(translate)